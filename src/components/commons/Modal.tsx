...
import { ModalWrapper, ModalBox, ModalCloseButton, ModalItemWrapper, ToonWrapper, Pagination, ModalControl } from "@styles/commons/modal.style";
    ...
    return (
        <ModalWrapper className={modalOpen ? "open" : ""}>
            <ModalBox className={type === "toon" ? "toon" : "video"}>
                <ModalCloseButton onClick={() => setModalOpen(false)}>X</ModalCloseButton>
                        ...
                        <ToonWrapper>
                            {pages === 0 ? (
                                ...
                                <Swiper
                                    ...
                                    slidesPerView={1}
                                    touchRatio={0}
                                    onSwiper={(swiper: SwiperType) => (swiperRef.current = swiper)} // 타입 지정
